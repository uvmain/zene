...
func StartServer() {
	...
	router.Handle("POST /api/playcounts", auth.AdminAuthMiddleware(http.HandlerFunc(handlers.HandleUpsertPlaycount)))                     // return handlers.StandardResponse; query params: user_id=1, musicbrainz_track_id=musicBrainzTrackId

...
<template>
  <div v-if="currentlyPlayingTrack || currentlyPlayingPodcastEpisode" class="max-w-xs w-full flex flex-row items-center gap-2 lg:max-w-200 lg:max-w-lg sm:max-w-md lg:gap-2">

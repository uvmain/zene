...
<template>
  ...
  >
    <icon-nrk-arrow-right
      class="size-8 translate-y--1 text-accent2 opacity-0 transition-all duration-300"
      :class="{
...
<style scoped>
.navlink {
  @apply block flex gap-x-1 py-2 text-zgray-200 font-semibold no-underline transition-all duration-100 uppercase;
}
</style>

...
export default defineConfig({
  shortcuts: {
    ...
    'z-button': 'border-1 border-solid border-primary relative font-semibold corner-cut flex cursor-pointer items-center justify-center cursor-pointer px-3 py-1 text-sm outline-none transition-all duration-200 text-muted background-2 hover:(from-primary-200 text-primary bg-gradient-to-br border-primary-400)',

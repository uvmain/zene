...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      main: {
        50: 'hsl(from var(--main-colour) h s 95%)',
        100: 'hsl(from var(--main-colour) h s 90%)',
        200: 'hsl(from var(--main-colour) h s 80%)',
        300: 'hsl(from var(--main-colour) h s 70%)',
        400: 'hsl(from var(--main-colour) h s 60%)',
        500: 'hsl(from var(--main-colour) h s 50%)',
        600: 'hsl(from var(--main-colour) h s 40%)',
        700: 'hsl(from var(--main-colour) h s 30%)',
        800: 'hsl(from var(--main-colour) h s 20%)',
        900: 'hsl(from var(--main-colour) h s 10%)',
        950: 'hsl(from var(--main-colour) h s 5%)',
      },
    },
  },
  presets: [

...
func HandleGetPlayqueue(w http.ResponseWriter, r *http.Request) {
	...
	playqueueResponse := &types.Playqueue{}
	...
	playqueueResponse.Current = playqueue.TrackIds[playqueue.CurrentIndex]
	...
	response.SubsonicResponse.PlayQueue = playqueueResponse
